...
const BuyCredit = () => {
  return (
    <div className='min-h-[80h] text-center pt-14 mb-10'>
      <button className='border-2 border-gray-400 px-10 py-2 rounded-full mb-6 text-2xl'>Our Plan</button>
      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-600 bg-clip-text text-transparent mb-6 sm:mb-10'>Choose the plan that's right for you</h1>
